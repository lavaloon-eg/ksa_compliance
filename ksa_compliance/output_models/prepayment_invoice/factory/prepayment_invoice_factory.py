...
class PrepaymentInvoiceFactory(Factory):
    ...
    def create(zatca_fields_dto: dict, doc: SalesInvoice):
        ...
        return (
            ...
            .set_prepaid_amount_xml_tag(
                PrepaymentInvoiceFactory._get_xml_tag(currency, prepaid_amount)
            )
            .set_invoice_lines(
                PrepaymentInvoiceFactory._get_invoice_lines(zatca_fields_dto, doc)
            )
            .build()
            )
