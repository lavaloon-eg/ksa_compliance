...
def execute():
    fields = ['Sales Invoice-custom_qr_code', 'Sales Invoice Item-custom_tax_total',
              'Sales Invoice Item-custom_total_after_tax', 'Sales Invoice Item-custom_column_break_sm8qq',
