...
def execute():
    ...
    if existing_settings:
        for setting in existing_settings:
            ...
            max_invoice_counter = frappe.db.sql("""
            ...
            """, {"company": setting.company}, as_dict=1)[0].max_invoice_counter or 0
            ...
            if max_invoice_counter:
                ...
                """, {"max_counter": max_invoice_counter, "company": setting.company}, as_dict=1)[0].invoice_hash
