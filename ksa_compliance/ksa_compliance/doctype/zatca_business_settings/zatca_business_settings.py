...
class ZATCABusinessSettings(Document):
    ...
    @staticmethod
    def for_invoice(invoice_id: str, doctype: Literal["Sales Invoice", "POS Invoice"]) -> Optional[
