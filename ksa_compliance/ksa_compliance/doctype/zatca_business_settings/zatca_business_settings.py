...
class ZATCABusinessSettings(Document):
    ...
    def onboard(self, otp: str) -> NoReturn:
        ...
        if not self.zatca_path:
            frappe.throw(_("Please configure 'Zatca Path'"))
    ...
    def _generate_csr(self) -> cli.CsrResult:
        ...
        return cli.generate_csr(self.zatca_path, self.vat_registration_number, config)
